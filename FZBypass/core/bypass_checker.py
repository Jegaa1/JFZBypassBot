...
async def direct_link_checker(link, onlylink=False):
    ...
    # DDL Links
        ...
        blink = await transcript(link, "https://go.bloggingaro.com/", "https://marioworlds.bloggingaro.com/", 6)
        ...
        blink = await transcript(link, "https://last.moneycase.link/", "https://infokeeda.xyz/", 8)
